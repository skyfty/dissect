...
public:
    ...
    Q_INVOKABLE void toggleAllFloatWidget();


    Q_INVOKABLE void toggleDockWidget(QQuickItem* dockWidget);
    Q_INVOKABLE void toggleDockWidget(const QString& name, const QString &title, KDDockWidgets::Location loc = KDDockWidgets::Location_None,QQuickItem *relativeTo=nullptr, QRect suggestedRect = {},InitialVisibilityOption option = {});
    Q_INVOKABLE void createWidget(const QString& title, const QString &genre);
