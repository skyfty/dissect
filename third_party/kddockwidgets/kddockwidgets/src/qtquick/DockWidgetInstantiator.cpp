...
bool DockWidgetInstantiator::isCloseable() const {
    return m_dockWidget && m_dockWidget->isOpen();

}

void DockWidgetInstantiator::setCloseable(bool b) {
...
void DockWidgetInstantiator::moveToCenter() {

    if (m_dockWidget)
        m_dockWidget->moveToCenter();
}
...
void DockWidgetInstantiator::componentComplete()
{
    ...
    m_dockWidget = ViewFactory::self()
                       ->createDockWidget(m_uniqueName, qmlEngine(this), m_options)
...
DockWidgetOptions DockWidgetInstantiator::options() const
{
    return m_options;
}

void DockWidgetInstantiator::setOptions(const DockWidgetOptions &newOptions)
{
