...
Rectangle {
    ...
    readonly property bool isFloating: titleBarCpp && titleBarCpp.isFloating
    readonly property bool moreButtonVisible: titleBarCpp && titleBarCpp.moreButtonVisible
    ...
    onMoreButtonClicked: {
        titleBarCpp.onMoreButtonClicked();
    }
