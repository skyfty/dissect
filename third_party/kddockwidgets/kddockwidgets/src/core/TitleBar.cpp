...
bool TitleBar::moreButtonVisible() const
{
...
void TitleBar::setMoreButtonVisible(bool visible)
{
    if (visible != m_moreButtonVisible) {
        m_moreButtonVisible = visible;
        d->moreButtonVisibleChanged.emit(visible);
    }
}
...
void TitleBar::onMoreButtonClicked()
{
//    toggleMaximized();
}
