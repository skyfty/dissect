...
int32_t PanTompkins::StateMachine(int32_t datum)
{
	int32_t BeatDelay = 0;
...
void PanTompkins::LearningPhase1(uint32_t* pkI, int32_t* pkBP)
{
...
void PanTompkins::LPFilter(int32_t* val)
{
	// -- To avoid using modulo employ half-pointer -- //
	int32_t half_pointer, w;
...
**********************************************************************************/
void PanTompkins::HPFilter(void)
{
	// -- To avoid using modulo employ half-pointer -- //
	int32_t half_pointer, h_prev_pointer;
...
void PanTompkins::DerivFilter(void)
{
...
**********************************************************************************/
void PanTompkins::SQRFilter(void)
{
	// ------------ Avoiding Overflow -------------- //
	uint32_t temp;
	if (PT_dptr->DRF_val > SQR_LIM_VAL || PT_dptr->DRF_val < (-SQR_LIM_VAL))
		PT_dptr->SQF_val = UINT32_MAX;
	else
	{
		if (PT_dptr->DRF_val < 0)
			temp = (uint32_t)(-PT_dptr->DRF_val);
		else
			temp = (uint32_t)(PT_dptr->DRF_val);
...
void PanTompkins::MVAFilter(void)
{
	...
	PT_dptr->MVA_val = MV_sum / (uint32_t)MVA_BUFFER_SIZE;
...
**********************************************************************************/
uint32_t PanTompkins::PeakDtcI(void)
{
	uint32_t p;
	// ---------- Local maxima or not --------- //
...
**********************************************************************************/
void PanTompkins::PeakDtcDR(int32_t DR_sample)
{
...
**********************************************************************************/
void PanTompkins::PeakDtcBP(int32_t DR_sample)
{
	if (DR_sample < 0) DR_sample = -DR_sample;
	// ---------- Local maxima or not --------- //
...
**********************************************************************************/
void PanTompkins::UpdateRR(int32_t qrs)
{
...
**********************************************************************************/
void PanTompkins::UpdateThI(uint32_t* PEAKI, int8_t NOISE_F)
{
...
**********************************************************************************/
void PanTompkins::UpdateThF(int32_t* PEAKF, int8_t NOISE_F)
{
	// ------ Update Noise & Signal Estimate ------ //
	if (NOISE_F) {
...
int32_t PanTompkins::PT_get_State_output(void) {
...
int32_t PanTompkins::PT_get_LPFilter_output(void) {
	return (PT_dptr->LPF_val);
}

// ------Returns HP filter value ------ //
int32_t PanTompkins::PT_get_HPFilter_output(void) {
	return (PT_dptr->HPF_val);
}

// ------Returns Dr filter value ------ //
int32_t PanTompkins::PT_get_DRFilter_output(void) {
	return (PT_dptr->DRF_val);
}

// ------Returns MVA filter value ------ //
uint32_t PanTompkins::PT_get_MVFilter_output(void) {
	return (PT_dptr->MVA_val);
}

// ------Returns SQR filter value ------ //
uint32_t PanTompkins::PT_get_SQRFilter_output(void) {
...
*************************************/
int32_t PanTompkins::PT_get_ShortTimeHR_output(int32_t Fs) {
...
Input - Fs : Sampling Frequency of the signal
*************************************/
int32_t PanTompkins::PT_get_LongTimeHR_output(int32_t Fs) {
	return (60 / (PT_dptr->RR_M / Fs));
}


// ------Returns the main threshold integrated signal Th value ------ //
uint32_t PanTompkins::PT_get_ThI1_output(void) {
	return (PT_dptr->ThI1);
}

// ------Returns the main threshold BP signal Th value ------ //
int32_t PanTompkins::PT_get_ThF1_output(void) {
	return (PT_dptr->ThF1);
}

// ------Returns Signal Level Estimate in Integrated Signal ----- //
uint32_t PanTompkins::PT_get_SKPI_output(void) {
	return (PT_dptr->SPKI);
}

// ------Returns Noise Level Estimate in Integrated Signal ------ //
uint32_t PanTompkins::PT_get_NPKI_output(void) {
	return (PT_dptr->NPKI);
}

// ------Returns Signal Level Estimate in BP Signal ------ //
int32_t PanTompkins::PT_get_SPKF_output(void) {
	return (PT_dptr->SPKF);
}

// ------Returns Noise Level Estimate in BP Signal ------ //
int32_t PanTompkins::PT_get_NPKF_output(void) {
	return (PT_dptr->NPKF);
}

// ------Returns HR state -> Regular:0, Irregular:1 ------ //
int32_t PanTompkins::PT_get_HRState_output(void) {
