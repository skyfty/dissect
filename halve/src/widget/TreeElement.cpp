...
QQmlListProperty<TreeElement> TreeElement::items(){
    QQmlListProperty<TreeElement> g(this,this,
...
qsizetype TreeElement::countElement(QQmlListProperty<TreeElement> *property){
    TreeElement *parent = qobject_cast<TreeElement *>(property->object);
    return parent->count();
}
...
TreeElement *TreeElement::atElement(QQmlListProperty<TreeElement> *property, qsizetype index){
    TreeElement *parent = qobject_cast<TreeElement *>(property->object);
